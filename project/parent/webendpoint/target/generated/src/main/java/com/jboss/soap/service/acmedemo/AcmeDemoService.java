...
public class AcmeDemoService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/christina/Desktop/jboss-fuse-travelagency/project/parent/webendpoint/src/main/resources/wsdl/AcmeDemoInterface.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AcmeDemoService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/christina/Desktop/jboss-fuse-travelagency/project/parent/webendpoint/src/main/resources/wsdl/AcmeDemoInterface.wsdl");
        }
        WSDL_LOCATION = url;
    }
